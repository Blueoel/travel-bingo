...
function missionIconSource(
  ...
  if (mission.done) return "/icons/ui/check.svg?v=125";
  ...
  if (
    ...
    return "/icons/ui/location.svg?v=125";
  }
  if (
    mission.kind === "PHOTO" ||
    label.includes("사진") ||
    ...
    return placement === "BOARD" ? "/icons/ui/camera.svg?v=125" : "/icons/ui/photo.svg?v=125";
  }
  if (
    ...
    return "/icons/ui/pencil.svg?v=125";
  }
  if (
    ...
    return "/icons/ui/timer.svg?v=125";
  }
  if (mission.kind === "WALK_DISTANCE" || mission.kind === "WALK_STEPS") {
    return "/icons/ui/footprint.svg?v=125";
  }
  if (mission.kind === "QUIZ") return "/icons/ui/question.svg?v=125";
  if (mission.kind === "QR_SCAN") return "/icons/ui/lock.svg?v=125";
  return "/icons/ui/check.svg?v=125";
}
  ...
  return (
    <main className="app-shell">
      ...
      <button type="button" className="bingo-share-card" onClick={() => void shareBingoBoard()} disabled={sharingBingo}>
        <span aria-hidden="true"><img src="/icons/ui/share.svg?v=125" alt="" /></span>
        ...
        <section className="home-screen">
          ...
          >
            ...
            <div className="daily-notebook" aria-hidden="true">
              <i><img src="/icons/ui/timer.svg?v=125" alt="" /></i>
              <i><img src="/icons/ui/camera.svg?v=125" alt="" /></i>
              <i><img src="/icons/ui/pencil.svg?v=125" alt="" /></i>
              <i><img src="/icons/ui/star.svg?v=125" alt="" /></i>
            </div>
          </button>
      ...
      {activeTab === "regions" && (
        <section className="region-directory-screen">
          ...
          <label className="region-search-box">
            <img src="/icons/ui/search.svg?v=125" alt="" />
            <input
              type="search"
              value={regionSearch}
              ...
              {regionDirectoryResults.map(({ region, fullName, bingo }) => (
                ...
                >
                  <span className="region-directory-pin" aria-hidden="true">
                    <img src={bingo ? "/icons/ui/location.svg?v=125" : "/icons/ui/lock.svg?v=125"} alt="" />
                  </span>
                  <span>
                    ...
                    <article className="active-region-slide" key={record.regionCode}>
                      ...
                      <div className={`region-progress-note ${record.unlocked ? "unlocked" : ""}`}>
                        <span aria-hidden="true">
                          <img
                            src={record.photoUrl ? "/icons/ui/check.svg?v=125" : "/icons/ui/pencil.svg?v=125"}
                            alt=""
                          />
                        </span>
      ...
      {activeTab === "my" && (
        <section className="my-screen">
          <header className="my-header">
            ...
            {myView === "main" && <button type="button" className="my-settings-button" aria-label="설정 열기" onClick={() => void openSettings()}><img src="/icons/ui/settings.svg?v=125" alt="" /></button>}
          </header>
          {myView === "travel-note" ? (
          ...
          <div className="my-profile-card">
            <button className="my-avatar" type="button" aria-label="프로필 사진 변경" onClick={() => profilePhotoInput.current?.click()}>
              ...
              <i aria-hidden="true"><img src="/icons/ui/pencil.svg?v=125" alt="" /></i>
            </button>
          ...
          <button className="my-travel-note-summary" type="button" onClick={() => setMyView("travel-note")}>
            ...
            <span className="my-travel-preview">
              <i aria-hidden="true"><img src="/icons/ui/travel-note.svg?v=125" alt="" /></i>
              <span>
          ...
          <div className="my-menu">
            ...
            >
              <span><img src="/icons/ui/footprint.svg?v=125" alt="" /></span>
            ...
            <button type="button" onClick={() => void openBadges()}>
              <span><img src="/icons/ui/achievement.svg?v=125" alt="" /></span>
              획득 배지
              <b>›</b>
            </button>
            <button type="button" onClick={() => setMyView("rewards")}>
              <span><img src="/icons/ui/reward.svg?v=125" alt="" /></span>
              랭킹 보상 이력
              <b>›</b>
            </button>
            <button type="button" onClick={() => void openSupport()}>
              <span><img src="/icons/ui/pencil.svg?v=125" alt="" /></span>
              신고·문의
              <b>›</b>
            </button>
            <button type="button" onClick={() => void openSettings()}>
              <span><img src="/icons/ui/settings.svg?v=125" alt="" /></span>
              설정
              <b>›</b>
            </button>
          </div>
            ...
            <div className="side-menu-scroll">
              <section className="side-menu-group">
                ...
                <button type="button" onClick={() => { setMenuOpen(false); setAnnouncementsOpen(true); }}>
                  <span aria-hidden="true"><img src="/icons/ui/notification.svg?v=125" alt="" /></span><b>공지사항과 알림</b><i>›</i>
                </button>
                <button type="button" onClick={() => { setMenuOpen(false); setActiveTab("my"); setMyView("badges"); }}>
                  <span aria-hidden="true"><img src="/icons/ui/achievement.svg?v=125" alt="" /></span><b>획득한 배지</b><i>›</i>
                </button>
                <button type="button" onClick={() => { setMenuOpen(false); setFriendsOpen(true); void loadFriends(); }}>
                  <span aria-hidden="true"><img src="/icons/ui/footprint.svg?v=125" alt="" /></span><b>친구 관리</b><i>›</i>
                </button>
              </section>
              ...
              <section className="side-menu-group side-menu-guides">
                <small>이용 안내</small>
                <details>
                  <summary><span aria-hidden="true"><img src="/icons/ui/info.svg?v=125" alt="" /></span><b>Travel Bingo 이용 방법</b><i>⌄</i></summary>
                  <p>매일 새로운 Daily 빙고에 도전하고, 여행지에서는 지역 빙고를 시작해보세요. 미션을 한 줄 완성할 때마다 포인트와 기록이 쌓입니다.</p>
                </details>
                <details>
                  <summary><span aria-hidden="true"><img src="/icons/ui/notice.svg?v=125" alt="" /></span><b>GPS·사진 인증 안내</b><i>⌄</i></summary>
                  <p>GPS 미션은 야외에서 위치 권한을 허용해주세요. 사진에는 주변 사람의 얼굴이나 차량번호가 나오지 않도록 촬영해주세요.</p>
                </details>
                <details>
                  <summary><span aria-hidden="true"><img src="/icons/ui/notice.svg?v=125" alt="" /></span><b>관광정보 활용 안내</b><i>⌄</i></summary>
              ...
              <section className="side-menu-group">
                ...
                <button type="button" onClick={() => { setMenuOpen(false); setActiveTab("my"); void openSettings(); }}>
                  <span aria-hidden="true"><img src="/icons/ui/settings.svg?v=125" alt="" /></span><b>계정 및 앱 설정</b><i>›</i>
                </button>
              </section>
            </div>
      ...
      <nav>
        ...
        >
          <img src="/icons/navigation/explore.svg?v=125" alt="" aria-hidden="true" />탐험
        </button>
        <button
          className={
        ...
        >
          <img src="/icons/navigation/bingo.svg?v=125" alt="" aria-hidden="true" />빙고
        </button>
        <button
          className={activeTab === "home" ? "active" : ""}
          onClick={() => setActiveTab("home")}
        >
          <img src="/icons/navigation/home.svg?v=125" alt="" aria-hidden="true" />홈
        </button>
        <button
          className={activeTab === "ranking" ? "active" : ""}
          onClick={() => setActiveTab("ranking")}
        >
          <img src="/icons/navigation/ranking.svg?v=125" alt="" aria-hidden="true" />랭킹
        </button>
        <button
          className={activeTab === "my" ? "active" : ""}
          onClick={() => setActiveTab("my")}
        >
          <img src="/icons/navigation/my.svg?v=125" alt="" aria-hidden="true" />마이페이지
        </button>
      </nav>
      {message && !selected && (
        <button
        ...
        <div className="modal-backdrop" onClick={closeMission}>
          ...
          >
            <header className="mission-detail-header">
              ...
              <b>미션 상세</b>
              <span aria-hidden="true"><img src="/icons/ui/heart.svg?v=125" alt="" /></span>
            </header>
            {selected.kind === "PHOTO" && photoStage === "COMPLETE" ? (
              <div className="mission-complete">
                ...
                <div className="completion-medal" aria-hidden="true">
                  <img src="/icons/ui/check.svg?v=125" alt="" />
                </div>
