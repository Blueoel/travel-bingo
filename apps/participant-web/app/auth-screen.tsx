  ...
  return (
    <main className="auth-shell">
      ...
      <form className="auth-form" onSubmit={submit}>
        {mode === "register" && (
          <label>
            <span className="field-icon"><img src="/icons/navigation/my.svg?v=125" alt="" /></span>
            <input
              value={name}
        ...
        {(mode === "login" || mode === "register" || mode === "forgot") && <label>
          <span className="field-icon"><img src="/icons/ui/mail.svg?v=125" alt="" /></span>
          <input
            type="email"
            value={email}
        ...
        {(mode === "login" || mode === "register" || mode === "reset") && <label>
          <span className="field-icon"><img src="/icons/ui/key.svg?v=125" alt="" /></span>
          <input
