...
export class FriendsController {
  ...
  @Delete("blocks/:id") async unblock(@Param("id") id: string, @Headers("cookie") c?: string, @Headers("x-user-id") d?: string): Promise<{ unblocked: boolean }> { return this.friends.unblock(await this.user(c, d), id); }
}
